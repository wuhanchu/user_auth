...
class LadpServer():
    ...
    def get_all_user_info(self):
        ...
        att_list = ['objectGUID','name','uid','title','sAMAccountName','mobile','userAccountControl','displayName', 'description','mail','memberOf','distinguishedName']
        ...
        if res:
            return [item.get("attributes") for item in res  if item.get("attributes")] 
        else:
