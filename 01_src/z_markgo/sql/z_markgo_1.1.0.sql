/*
 ...
 Source Server         : markgo
 Source Server Type    : MySQL
 Source Server Version : 50643
 Source Host           : dataknown.tpddns.cn:50306
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'AI服务' ROW_FORMAT = Compact;
...
CREATE TABLE `mark_project`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 101 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '标注项目' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3402 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '语音标注条目' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 603 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `sys_param`  (
  `PARAM_CODE` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '???????',
  `PARAM_NAME` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '???????',
  `PARAM_GROUP` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '???????',
  `PARAM_VALUE` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '????ֵ',
  `PARAM_TYPE` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '????????\n            NUMBER:????\n            CHAR:?ַ???\n            DATA:???',
  `NOTE` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '??ע',
  PRIMARY KEY (`PARAM_CODE`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'SYS_PARAM??ϵͳ?????��' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for sys_param_code
-- ----------------------------
DROP TABLE IF EXISTS `sys_param_code`;
CREATE TABLE `sys_param_code`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `value` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '对应代码的值为key值',
  `type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '类型，用于归类',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限角色表\r\n' ROW_FORMAT = Compact;
...
INSERT INTO `sys_role` VALUES (1, 'superadmin', NULL, '超管', NULL, 1566644576, NULL);
INSERT INTO `sys_role` VALUES (2, '标注员', NULL, '标注员', NULL, 1566644592, NULL);
INSERT INTO `sys_role` VALUES (3, '质检员', NULL, '质检员', NULL, 1566644605, NULL);
INSERT INTO `sys_role` VALUES (6, '客服', NULL, '客服', NULL, 1568189162, NULL);
INSERT INTO `sys_role` VALUES (7, '项目管理员', NULL, '项目管理员', NULL, 1568189177, NULL);
INSERT INTO `sys_role` VALUES (8, '普通用户', NULL, '普通用户', NULL, 1568189316, NULL);
INSERT INTO `sys_role` VALUES (9, '客户', NULL, '客户', NULL, 1568189338, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 66 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户角色表' ROW_FORMAT = Compact;

INSERT INTO `sys_user_role` VALUES (1, 12, 2);
