...
from base.webapi import app, DEFAULT_MODULES, base_user_api, base_menu_api, base_permission_api, \
    base_permission_menu_api, \
...
if __name__ == '__main__':
    ...
    app.run('0.0.0.0', debug=True, use_reloader=False, port=5000)
