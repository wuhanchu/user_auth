...
echo "启动新容器"
echo "docker run -d -p 5002:5002 --name $APP_NAME -e SQLALCHEMY_DATABASE_URI='mysql+pymysql://root:root@192.168.1.150:3306/$APP_NAME?charset=utf8' -v ~/tmp/$APP_NAME_items:/opt/$APP_NAME_items $APP_NAME:${VERSION}"
